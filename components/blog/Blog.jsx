...
const Blog = () => {
  ...
  return (
    <div className="mt-24  items-center 2xl:mt-44 lg:p-0 p-7 2xl:p-8 ">
      ...
      <div className="flex 2xl:justify-center flex-wrap md:gap-6 lg:space-x-4 mt-14 lg:space-y-0 space-y-5 md:space-y-0 ">
        {cards.map((card, i) => {
          return (
            <div className="2xl:w-[500px] 2xl:h-[600px] lg:w-[365px] w-80 h-96 md:w-[300px]  shadow_1 hovred_bg rounded-xl p-10 space-y-5 2xl:p-20">
              <img
