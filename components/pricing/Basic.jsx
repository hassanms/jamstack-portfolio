  ...
  return (
    <div className="  shadow_1 hovred_bg rounded p-10 mt-5 2xl:p-20  lg:w-[670px] 2xl:w-[950px] 2xl:ml-32">
      <div className=" lg:flex mt-5 md:flex md:justify-between lg:space-x-20  justify-around ">
        ...
        <div className="text-[#ff014f] font-extrabold rounded text-3xl 2xl:text-5xl ">
          {data?.dollar}
        </div>
      </div>
      <div className=" mt-10">
      ...
      <div className="2xl:w-[800px] 2xl:h-[80px] 2xl:text-2xl 2xl:p-5 font-bold text-center lg:w-[550px] lg:h-12  md:h-16 md:text-xl lg:text-sm md:p-4  h-10 rounded shadow_1 hovred_bg mt-5 p-2 hover:text-[#ff014f] shadow_1 lg:p-5 ">
