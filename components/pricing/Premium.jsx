    ...
    <div className="  shadow_1 hovred_bg rounded p-10 mt-5 2xl:p-20  lg:w-[670px] 2xl:w-[950px] 2xl:ml-32">
      ...
      <div className="lg:flex md:flex lg:space-x-10 mt-5 text-xl md:justify-between">
        <div className="flex space-x-2 ">
          ...
          <div className="space-y-5 text-xs lg:text-xl md:text-xl 2xl:text-3xl 2xl:mt-1">
            <div>{price[0]?.attributes.PremiumPrice[0].h1}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h2}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h3}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h4}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h5}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h6}</div>
          </div>
        </div>
        <div className="flex space-x-2 mt-5 lg:mt-0 md:mt-0">
          ...
          <div className="space-y-5 text-xs lg:text-xl md:text-xl 2xl:text-3xl 2xl:mt-1">
            <div>{price[0]?.attributes.PremiumPrice[0].h7}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h8}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h9}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h10}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h11}</div>
            <div>{price[0]?.attributes.PremiumPrice[0].h12}</div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:flex md:flex lg:space-x-6 md:space-x-6 2xl:text-3xl 2xl:ml-0 2xl:mt-5 md:justify-center">
        <div className="flex mt-3 text-center space-x-2 lg:text-sm md:text-xl  2xl:text-3xl">
          ...
          <div>{price[0]?.attributes.PremiumPrice[0].h13}</div>
        </div>
        <div className="flex mt-3 text-center space-x-2 lg:text-sm md:text-xl  2xl:text-3xl">
          <div className="mt-1">
            <AiOutlineStock />
          </div>
          <div>{price[0]?.attributes.PremiumPrice[0].h14}</div>
        </div>
      </div>
    </div>
  );
