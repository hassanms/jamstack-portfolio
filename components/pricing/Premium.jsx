...
const Premium = () => {
  ...
  return (
    <div className="  shadow_1 hovred_bg rounded p-10 mt-5 2xl:p-20  lg:w-[630px] 2xl:w-[950px] 2xl:ml-32">
    ...
    <div className="lg:flex md:flex lg:space-x-6 lg:ml-32 md:space-x-6 2xl:text-3xl 2xl:ml-0 2xl:mt-5 md:justify-center">
